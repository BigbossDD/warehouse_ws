...
bool custom_interfaces__msg__robot_stat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._robot_stat.RobotStat", full_classname_dest, 43) == 0);
  }
  custom_interfaces__msg__RobotStat * ros_message = _ros_message;
  {  // battery_level
...
{
  /* NOTE(esteve): Call constructor of RobotStat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._robot_stat");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotStat");
